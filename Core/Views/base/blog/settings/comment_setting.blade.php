                ...
                <div class="row mb-5">
                    ...
                    <div class="col-md-12 row my-3">
                        ...
                        <div class="col-md-9">
                            <div class="form-check form-switch">
                                <input type="checkbox" class="form-check-input mb-2" name="default_comment_status" id="default_comment_status"
                    ...
                    <div class="col-md-12 row my-3">
                        ...
                        <div class="col-md-9">
                            <div class="mb-3">
                                <div class="form-check form-switch">
                                    <input type="checkbox" class="form-check-input" name="require_name_email" id="require_name_email"
                            ...
                            <div class="mb-3">
                                <div class="form-check form-switch">
                                    <input type="checkbox" class="form-check-input" name="comment_registration" id="comment_registration"
                            ...
                            <div class="mb-3">
                                <div class="form-check form-switch">
                                    <input type="checkbox" class="form-check-input" name="close_comments_for_old_blogs"
                            ...
                            <div class="mb-3">
                                <input type="checkbox" class="form-check-input" name="thread_comments" id="thread_comments"
                            ...
                            <div class="mb-3">
                                 <div class="form-check form-switch">
                                    <input type="checkbox" class="form-check-input" name="page_comments" id="page_comments"
                    ...
                    <div class="col-md-12 row my-3">
                        ...
                        <div class="col-md-9">
                            <div class="form-check form-switch">
                                <input type="checkbox" class="form-check-input mb-3" name="comments_notify_email" id="comments_notify_email"
                                ...
                                <input type="checkbox" class="form-check-input mb-2" name="comments_moderation_notify_email"
                    ...
                    <div class="col-md-12 row my-3">
                        ...
                        <div class="col-md-9">
                            <div class="form-check form-switch">
                                <input type="checkbox" class="form-check-input mb-3" name="comment_moderation" id="comment_moderation"
                                    value="1" {{ $data['comment_moderation'] == 1 ? 'checked' : '' }}>
                                <label for="comment_moderation"
                                    class="black d-inline">{{ translate('Comment must be manually approved') }}</label><br>

                                <input type="checkbox" class="form-check-input mb-2" name="comment_previously_approved"
                    ...
                    <div class="col-md-12 row mt-5">
                        ...
                        <div class="col-md-9">
                            ...
                            <textarea name="comment_moderation_keys" id="comment_textarea" class="form-control style--two" rows="5">{{ $data['comment_moderation_keys'] }}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12 row mt-5">
                        ...
                        <div class="col-md-9">
                            ...
                            <textarea name="comment_disallowed_keys" id="comment_textarea" class="form-control style--two" rows="5">{{ $data['comment_disallowed_keys'] }}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12 row my-3">
                        ...
                        <div class="col-md-9">
                            <div class="form-check form-switch">
                                <input type="checkbox" class="form-check-input mb-3" name="show_avatars" id="show_avatars" value="1"
                        ...
                        <div class="col-md-9">
                            ...
                            <div class="mb-2">
                                <div class="form-check">
                                    <input type="radio" class="form-check-input mb-3" name="avatar_default" id="mystery"
                                        value="mystery" {{ $data['avatar_default'] == 'mystery' ? 'checked' : '' }}>
                                        <img src="{{ asset('/public/comment-author-image/mystery.png') }}" alt="">
                                    <label for="mystery" class="form-check-label black">{{ translate('Mystery Person') }}</label><br>
                                </div>
                            </div>
                            ...
                            <div class="mb-2">
                                <div class="form-check">
                                    <input type="radio" class="form-check-input mb-3" name="avatar_default" id="blank"
                                        value="blank" {{ $data['avatar_default'] == 'blank' ? 'checked' : '' }}>
                                    <img src="{{ asset('/public/comment-author-image/blank.png') }}" alt="">
                                    <label for="blank" class="form-check-label black">{{ translate('Blank') }}</label><br>
                                </div>
                            </div>
                            ...
                            <div class="mb-2">
                                <div class="form-check">
                                    <input type="radio" class="form-check-input mb-3" name="avatar_default" id="gravatar"
                                        value="gravatar" {{ $data['avatar_default'] == 'gravatar' ? 'checked' : '' }}>
                                    <img src="{{ asset('/public/comment-author-image/gravatar.png') }}" alt="">
                                    <label for="gravatar" class="form-check-label black">{{ translate('Gravatar Logo') }}</label><br>
                                </div>
                            </div>
                            ...
                            <div class="mb-2">
                                <div class="form-check">
                                    <input type="radio" class="form-check-input mb-3" name="avatar_default" id="identicon"
                                        value="identicon" {{ $data['avatar_default'] == 'identicon' ? 'checked' : '' }}>
                                    <img src="{{ asset('/public/comment-author-image/identicon.png') }}" alt="">
                                    <label for="identicon"
                                        class="form-check-label black">{{ translate('Identicon (Generated)') }}</label><br>
                                </div>
                            </div>
                            ...
                            <div class="mb-2">
                                <div class="form-check">
                                    <input type="radio" class="form-check-input mb-3" name="avatar_default" id="wavatar"
                                        value="wavatar" {{ $data['avatar_default'] == 'wavatar' ? 'checked' : '' }}>
                                    <img src="{{ asset('/public/comment-author-image/wavatar.png') }}" alt="">
                                    <label for="wavatar" class="form-check-label black">{{ translate('Wavatar (Generated)') }}</label><br>
                                </div>
                            </div>
                            ...
                            <div class="mb-2">
                                <div class="form-check">
                                    <input type="radio" class="form-check-input mb-3" name="avatar_default" id="monsterid"
                                        value="monsterid" {{ $data['avatar_default'] == 'monsterid' ? 'checked' : '' }}>
                                    <img src="{{ asset('/public/comment-author-image/monsterid.png') }}" alt="">
                                    <label for="monsterid"
                                        class="form-check-label black">{{ translate('MonsterID (Generated)') }}</label><br>
                                </div>
                            </div>
                            ...
                            <div class="form-check-input">
                                <div class="form-check">
                                    <input type="radio" class="form-check-input mb-3" name="avatar_default" id="retro"
                                        value="retro" {{ $data['avatar_default'] == 'retro' ? 'checked' : '' }}>
                                    <img src="{{ asset('/public/comment-author-image/retro.png') }}" alt="">
                                    <label for="retro" class="form-check-label black">{{ translate('Retro (Generated)') }}</label><br>
                                </div>
                            </div>
