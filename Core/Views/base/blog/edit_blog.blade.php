                        ...
                        <div class="card-body">
                            ...
                            <div class="row mb-3">
                                ...
                                <input type="text" name="name" id="name"
                                        ...
                                        value="{{ $blog->translation('name', $lang) }}"
                            ...
                            <!--Permalink-->
                            <div
                                class="row mb-3 my-4 permalink-input-group @if (!empty($lang) && $lang != getDefaultLang()) area-disabled @endif">
                                <div class="col-sm-2">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    @else
                                        <a href="#"
                                            onclick="blogPreviewDraft('preview')">{{ url('') }}/blog/<span
                                                id="permalink">{{ $blog->permalink }}</span><span
                                                class="btn btn-sm btn-secondary ml-1 permalink-edit-btn">{{ translate('Edit') }}</span></a>
                                    @endif
                                    ...
                                    <div class="permalink-editor d-none">
                                        ...
                                        <button type="button" class="btn btn-sm btn-danger mt-2 btn-danger permalink-cancel-btn"
                                            data-dismiss="modal">{{ translate('Cancel') }}</button>
                                        <button type="button"
                                            class="btn btn-sm btn-primary mt-2 permalink-save-btn">{{ translate('Save') }}</button>
                                    </div>
                                </div>
                            </div>
                            <!--End Permalink-->
                            ...
                            <div class="row mb-3">
                            <label for="short_description" class="col-sm-2 font-14 bold black">{{ translate('Short Description') }}<span
                                        class="text-danger"> * </span></label>
                                <div class="col-sm-10">
                                <textarea name="short_description" class="form-control"
                                        placeholder="{{ translate('Short Description') }}" id="short_description">{{ $blog->translation('short_description', $lang) }}</textarea>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <div class="editor-wrap">
                                        <textarea name="content" class="form-control" id="blog_content" data-href="">{{ $blog->translation('content', $lang) }}</textarea>
                                    </div>
                    ...
                    <div class="card custom-card mb-4">
                        ...
                        <div class="collapse show" id="collapseSeo">
                            <div class="card-body">
                                ...
                                <div class="row mb-3">
                                    <label for="name" class="col-sm-2 col-form-label">{{ translate('Meta Description') }}</label>
                                    <div class="col-sm-10">
                        ...
                        <div class="@if (!empty($lang) && $lang != getDefaultLang()) area-disabled @endif">
                            <div class="card-header justify-content-between">
                                ...
                                <div class="mx-1 my-2 d-none" id="visibility_form">
                                    <input type="radio" class="form-check-input" {{ $blog->visibility == 'public' ? 'checked' : '' }}
                                    ...
                                    <span id="sticky-span" class="ml-4">
                                        <input id="sticky" class="form-check-input" name="sticky" type="checkbox"value="sticky"
                                            {{ $blog->is_sticky == 1 ? 'checked' : '' }} />
                                        <label for="sticky"
                                            class="form-check-label selectit">{{ translate('Stick this post to the front of blog list page') }}</label><br />
                                    </span>

                                    <input type="radio" class="form-check-input" {{ $blog->visibility == 'password' ? 'checked' : '' }}
                                    ...
                                    <span id="password-span" class="ml-4">
                                        <input type="text" class="form-control" name="blog_password" id="blog_password"
                                            value="{{ $blog->blog_password }}" maxlength="10" /><br />
                                        <span
                                    ...
                                    <input type="radio" class="form-check-input" {{ $blog->visibility == 'private' ? 'checked' : '' }}
                                ...
                                <div class="row my-2 mx-1">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" name="publish_at" id="publish_at" value="{{ $blog->publish_at }}" placeholder="Choose date with time">
                                        </div>
                                    </div>
                                 </div>
                    ...
                    <div class="col-12 @if (!empty($lang) && $lang != getDefaultLang()) area-disabled @endif">
                        ...
                        <div class="card custom-card mt-md-5  col-12">
                            ...
                            <div class="collapse show" id="collapseFormat">
                                <div class="card-body">
                                    <div class="mx-1 mt-2">
                                        <input class="form-check-input" type="radio" @checked($blog->formate == 'standard') name="formate" id="formate-standard"
                                            value="standard" />
                                        <label for="formate-standard" class="mb-1">{{ translate('Standard') }}</label>
                                        <br />
                                        <input class="form-check-input" type="radio" @checked($blog->formate == 'video') name="formate" id="formate-video"
                                            value="video" />
                                        <label for="formate-video" class="mb-1">{{ translate('Video') }}</label>
                                        <br />
                                        <input class="form-check-input" type="radio" @checked($blog->formate == 'audio') name="formate" id="formate-audio"
                                            value="audio" />
                                        <label for="formate-audio" class="mb-1">{{ translate('Audio') }}</label>
                                        <br />
                                        <input class="form-check-input" type="radio" @checked($blog->formate == 'gallery') name="formate" id="formate-gallery"
                                            value="gallery" />
                        ...
                        {{-- Blog Gallery Image --}}
                        <div class="card custom-card mt-5 col-12 @if ($blog->formate !== 'gallery') d-none @endif"
                            id="galler-images">
                            <div class="card-header justify-content-between">
                                <div class="card-title">
                                    {{ translate('Gallery') }}
