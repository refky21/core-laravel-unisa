...
@endsection
@section('custom_css')
    <link href="{{ asset('/public/backend/assets/menu/jquery-ui/jquery-ui.min.css') }}" rel="stylesheet" type="text/css">
    <link rel="stylesheet" href="{{ asset('/public/backend/assets/menu/select2/select2.min.css') }}">
...
<div class="row">
    <div class="col-md-12">
        <ul class="nav nav-tabs tab-style-1 d-sm-flex d-block" role="tablist">
            <li class="nav-item">
                <a class="nav-link active" id="edit_menus-tab" data-bs-toggle="tab"  
                    aria-controls="edit_menus" aria-selected="true" data-bs-target="#edit_menus"
                    aria-current="page" href="#edit_menus">{{ translate('Edit Menus') }}</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" data-bs-toggle="tab" id="manage_location-tab" data-bs-target="#manage_location"
                    aria-controls="manage_location" aria-selected="false"
                    href="#manage_location">{{ translate('Manage Locations') }}</a>
            </li>
        </ul>
    </div>
</div>
...
@section('custom_scripts')
    <script src="{{ asset('/public/backend/assets/menu/jquery-ui/jquery-ui.min.js') }}"></script>
    ...
    <script src="{{ asset('/public/backend/assets/menu/select2/select2.min.js') }}"></script>
