    ...
    <div class="attachment-meta-wrap">
        <form method="POST">
            ...
            <div class="d-flex gap-10 justify-content-end flex-wrap mt-2">
                @can('Manage Media')
                <button type="button" class="btn btn-icon btn-danger btn-wave waves-effect waves-light" onclick="deleteMediaFile()">
                    <i class="bi bi-trash"></i>
                </button>
                @endcan
                <button type="button" class="btn btn-info btn-wave waves-effect waves-light insert_image">
                    {{translate('Insert')}}
                </button>
            </div>
        </form>
