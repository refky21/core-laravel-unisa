...
<form action="#" class=" widget_input_field_form px-3 py-3 bg-white"
    ...
    <div class="form-group @if (!empty($lang) && $lang != getDefaultLang()) area-disabled @endif">
        ...
        <input type="number" class="form-control" id="per_slide_number" name="per_slide_number"
    ...
    <div class="form-group @if (!empty($lang) && $lang != getDefaultLang()) area-disabled @endif">
        ...
        <input type="number" class="form-control" id="total_blog_number" name="total_blog_number"
